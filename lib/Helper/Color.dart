...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffF32F42);
  static const Color pramod = Color(0xffF32F42);
  // 0xffF32F42
  // 0xff0E3568
  static const Color secondary = Color(0xffF32F42);
  ...
  static const Color grad1Color = Color(0xffF32F42);
  static const Color grad2Color = Color(0xffF32F42);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffF32F42);
  ...
  static const Color darkColor2 = Color(0xffF32F42);
  static const Color darkColor3 = Color(0xffF32F42);
