  ...
  Future<Null> _getAddress() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print("getAddress=================${getAddressApi.toString()}");
  ...
  void addAddressModel() {
    for (int i = 0; i < addressList.length; i++) {
      addModel.add(RadioModel(
          ...
          add:
              "${addressList[i].address!}, ${addressList[i].area.toString()}, ${addressList[i].city.toString()}, ${addressList[i].state!}, ${addressList[i].country!}, ${addressList[i].pincode!}",
